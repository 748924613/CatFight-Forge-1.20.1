...
public final class CatFightCatModel extends CatModel<Cat> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // It still uses the cat's own texture: each box draws only its upward face and maps
        // it to a known opaque body panel in the vanilla 64x32 cat atlas.  This preserves
        // every cat's colour (including resource-pack skins) without sampling transparent
        // padding or repeating a paw/body fragment along the thin vertical sides.
        root.addOrReplaceChild("catfight_pancake_head",
                CubeListBuilder.create().texOffs(18, 7)
                        .addBox(-3.0F, 0.0F, -3.0F, 6.0F, 1.0F, 6.0F, Set.of(Direction.UP)),
                PartPose.offset(0.0F, 22.94F, -8.0F));
        root.addOrReplaceChild("catfight_pancake_body",
                CubeListBuilder.create().texOffs(12, 7)
                        .addBox(-2.0F, 0.0F, -5.0F, 4.0F, 1.0F, 10.0F, Set.of(Direction.UP)),
        ...
        root.addOrReplaceChild("catfight_pancake_left_front_leg",
                CubeListBuilder.create().texOffs(23, 7)
                        .addBox(0.0F, 0.0F, -1.0F, 5.0F, 1.0F, 2.0F, Set.of(Direction.UP)),
        ...
        root.addOrReplaceChild("catfight_pancake_right_front_leg",
                CubeListBuilder.create().texOffs(23, 10)
                        .addBox(-5.0F, 0.0F, -1.0F, 5.0F, 1.0F, 2.0F, Set.of(Direction.UP)),
                PartPose.offset(-2.0F, 22.94F, -3.0F));
        ...
        root.addOrReplaceChild("catfight_pancake_tail",
                CubeListBuilder.create().texOffs(26, 14)
                        .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 6.0F, Set.of(Direction.UP)),
