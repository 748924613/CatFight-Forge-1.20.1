...
- 猫饼会以方头、长身、四条横腿和细尾巴的专用**一像素厚**扁平轮廓显示；它继续使用这只猫原本的皮肤与颜色（也兼容资源包猫皮），仅取原版猫皮中安全、不透明的区域绘制顶面，不会再出现重复拉花或透明缺块。它会完全固定在撞击位置、不能移动或转向，也不会参与对峙。用**空玻璃瓶**右键猫饼即可救回（玻璃瓶不会消耗）；十分钟无人救援会直接死亡。
